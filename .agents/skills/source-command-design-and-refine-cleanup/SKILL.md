---
name: "source-command-design-and-refine-cleanup"
description: "Clean up temporary design lab files and routes if a design session was interrupted"
---

# source-command-design-and-refine-cleanup

Use this skill when the user asks to run the migrated source command `design-and-refine-cleanup`.
...
Design exploration history preserved in:
  .Codex/.skills/design-and-refine/memory/
...
- **No design memory removed**: Design history in `.Codex/.skills/design-and-refine/memory/` is preserved
