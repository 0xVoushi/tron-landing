---
name: "source-command-seo-content-audit"
...
# source-command-seo-content-audit

Use this skill when the user asks to run the migrated source command `seo-content-audit`.
