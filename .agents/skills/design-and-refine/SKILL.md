...
- Archive design memory in `.Codex/.skills/design-and-refine/memory/`
...
See full reference: `.Codex/.skills/design-and-refine/skills/design-lab/DESIGN_PRINCIPLES.md`
