---
name: "source-command-code-review-copy"
...
# source-command-code-review-copy

Use this skill when the user asks to run the migrated source command `code-review copy`.
...
1. Read `AGENTS.md` for project style and conventions
...
You: *Fetches PR #42 details and diff*
     *Reviews against AGENTS.md conventions*
