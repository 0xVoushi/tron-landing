 ...
 *
 * On desktop this renders first (instant), then PixelBlast paints on top via
 * `transparent: true`. The SVG noise + brand tint stays visible through the
 * transparent canvas, giving the WebGL output a slightly richer base texture.
 */
